...
/**
 * ListRenditions200Response Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class ListRenditions200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listRenditions_200_response';
    ...
    protected static $openAPITypes = [
        'renditions' => '\iLoveVideoEditorSDK\Model\Rendition[]',
        'total' => 'int',
        'page' => 'int',
        'limit' => 'int',
        'total_pages' => 'int'
    ...
    {
        $this->setIfExists('renditions', $data ?? [], null);
    ...
    {
        return $this->container['renditions'];
    }

    /**
     * Sets renditions
     *
     * @param \iLoveVideoEditorSDK\Model\Rendition[]|null $renditions renditions
     *
     * @return self
     */
    public function setRenditions($renditions)
    {
        if (is_null($renditions)) {
            throw new \InvalidArgumentException('non-nullable renditions cannot be null');
        }
        $this->container['renditions'] = $renditions;
