...
/**
 * GetProject200Response Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetProject200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getProject_200_response';
    ...
    protected static $openAPITypes = [
        'project' => '\iLoveVideoEditorSDK\Model\Project',
        'last_rendition' => '\iLoveVideoEditorSDK\Model\Rendition'
    ];
    ...
    protected static $setters = [
        'project' => 'setProject',
        'last_rendition' => 'setLastRendition'
    ];
    ...
    protected static $getters = [
        'project' => 'getProject',
        'last_rendition' => 'getLastRendition'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('last_rendition', $data ?? [], null);
    }
     ...
     * Gets project
     *
     * @return \iLoveVideoEditorSDK\Model\Project
     */
     ...
     * Sets project
     *
     * @param \iLoveVideoEditorSDK\Model\Project $project project
     *
     * @return self
     */
     ...
     * Gets last_rendition
     *
     * @return \iLoveVideoEditorSDK\Model\Rendition|null
     */
    public function getLastRendition()
    {
        return $this->container['last_rendition'];
    }

    /**
     * Sets last_rendition
     *
     * @param \iLoveVideoEditorSDK\Model\Rendition|null $last_rendition last_rendition
     *
     * @return self
     */
    public function setLastRendition($last_rendition)
    {
        if (is_null($last_rendition)) {
            throw new \InvalidArgumentException('non-nullable last_rendition cannot be null');
        }
        $this->container['last_rendition'] = $last_rendition;
