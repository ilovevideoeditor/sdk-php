...
/**
 * ListWorkflowStepTypes200Response Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class ListWorkflowStepTypes200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listWorkflowStepTypes_200_response';
    ...
    {
        $this->setIfExists('step_types', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['step_types'] === null) {
            $invalidProperties[] = "'step_types' can't be null";
        }
    ...
    {
        return $this->container['step_types'];
    }

    /**
     * Sets step_types
     *
     * @param object[] $step_types step_types
     *
     * @return self
     */
    public function setStepTypes($step_types)
    {
        if (is_null($step_types)) {
            throw new \InvalidArgumentException('non-nullable step_types cannot be null');
        }
        $this->container['step_types'] = $step_types;
