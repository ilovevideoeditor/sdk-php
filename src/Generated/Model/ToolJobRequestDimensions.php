...
/**
 * ToolJobRequestDimensions Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class ToolJobRequestDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ToolJobRequest_dimensions';
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ToolJobRequestDimensions., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ToolJobRequestDimensions., must be bigger than or equal to 1.');
        }
