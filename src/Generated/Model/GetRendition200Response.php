...
/**
 * GetRendition200Response Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class GetRendition200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getRendition_200_response';
    ...
    protected static $openAPITypes = [
        'rendition' => '\iLoveVideoEditorSDK\Model\Rendition'
    ];
    ...
    {
        $this->setIfExists('rendition', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rendition'] === null) {
            $invalidProperties[] = "'rendition' can't be null";
        }
     ...
     * Gets rendition
     *
     * @return \iLoveVideoEditorSDK\Model\Rendition
     */
    public function getRendition()
    {
        return $this->container['rendition'];
    }

    /**
     * Sets rendition
     *
     * @param \iLoveVideoEditorSDK\Model\Rendition $rendition rendition
     *
     * @return self
     */
    public function setRendition($rendition)
    {
        if (is_null($rendition)) {
            throw new \InvalidArgumentException('non-nullable rendition cannot be null');
        }
        $this->container['rendition'] = $rendition;
