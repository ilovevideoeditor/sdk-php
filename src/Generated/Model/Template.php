...
class Template implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets tool_id
     *
     * @param string|null $tool_id tool_id
     *
     * @return self
     */
    ...
    /**
     * Gets variables_schema
     *
     * @return array<string,mixed>[]|null
     */
    public function getVariablesSchema()
    {
        return $this->container['variables_schema'];
    }

    /**
     * Sets variables_schema
     *
     * @param array<string,mixed>[]|null $variables_schema variables_schema
     *
     * @return self
     */
    public function setVariablesSchema($variables_schema)
    {
        if (is_null($variables_schema)) {
            array_push($this->openAPINullablesSetToNull, 'variables_schema');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('variables_schema', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['variables_schema'] = $variables_schema;
