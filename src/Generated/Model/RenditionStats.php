...
/**
 * RenditionStats Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class RenditionStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RenditionStats';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rendering', $data ?? [], null);
    }
    ...
    {
        return $this->container['rendering'];
    }

    /**
     * Sets rendering
     *
     * @param int|null $rendering rendering
     *
     * @return self
     */
    public function setRendering($rendering)
    {
        if (is_null($rendering)) {
            throw new \InvalidArgumentException('non-nullable rendering cannot be null');
        }
        $this->container['rendering'] = $rendering;
