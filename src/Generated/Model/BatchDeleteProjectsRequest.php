...
/**
 * BatchDeleteProjectsRequest Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class BatchDeleteProjectsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'batchDeleteProjects_request';
    ...
    public function setIds($ids)
    {
        ...
        if ((count($ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $ids when calling BatchDeleteProjectsRequest., number of items must be less than or equal to 100.');
        }
        if ((count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling BatchDeleteProjectsRequest., number of items must be greater than or equal to 1.');
        }
