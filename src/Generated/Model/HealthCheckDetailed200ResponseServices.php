...
/**
 * HealthCheckDetailed200ResponseServices Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class HealthCheckDetailed200ResponseServices implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'healthCheckDetailed_200_response_services';
    ...
    protected static $openAPITypes = [
        'redis' => '\iLoveVideoEditorSDK\Model\ServiceHealth',
        'supabase' => '\iLoveVideoEditorSDK\Model\ServiceHealth'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('supabase', $data ?? [], null);
    }
     ...
     * Gets redis
     *
     * @return \iLoveVideoEditorSDK\Model\ServiceHealth|null
     */
     ...
     * Sets redis
     *
     * @param \iLoveVideoEditorSDK\Model\ServiceHealth|null $redis redis
     *
     * @return self
     */
     ...
     * Sets supabase
     *
     * @param \iLoveVideoEditorSDK\Model\ServiceHealth|null $supabase supabase
     *
     * @return self
     */
    public function setSupabase($supabase)
    {
        if (is_null($supabase)) {
            throw new \InvalidArgumentException('non-nullable supabase cannot be null');
        }
        $this->container['supabase'] = $supabase;
