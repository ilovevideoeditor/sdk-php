...
/**
 * WebhookSubscriptionCreate Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class WebhookSubscriptionCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookSubscriptionCreate';
     ...
     * Sets url
     *
     * @param string $url Endpoint that receives signed render events.
     *
     * @return self
     */
     ...
     * Sets events
     *
     * @param string[]|null $events Events to subscribe to; defaults to all events.
     *
     * @return self
     */
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling WebhookSubscriptionCreate., number of items must be greater than or equal to 1.');
        }
