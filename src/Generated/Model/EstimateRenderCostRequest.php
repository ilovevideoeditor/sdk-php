...
/**
 * EstimateRenderCostRequest Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class EstimateRenderCostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'estimateRenderCost_request';
    ...
    protected static $openAPITypes = [
        'video_json' => '\iLoveVideoEditorSDK\Model\VideoJSON'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['video_json'] === null) {
            $invalidProperties[] = "'video_json' can't be null";
        }
     ...
     * Gets video_json
     *
     * @return \iLoveVideoEditorSDK\Model\VideoJSON
     */
     ...
     * Sets video_json
     *
     * @param \iLoveVideoEditorSDK\Model\VideoJSON $video_json video_json
     *
     * @return self
     */
