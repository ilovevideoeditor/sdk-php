...
/**
 * BillingPricesTiers Class Doc Comment
 *
 * @category Class
 * @package  iLoveVideoEditorSDK
 * @author   OpenAPI Generator team
 ...
 */
class BillingPricesTiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BillingPrices_tiers';
     ...
     * Sets starter
     *
     * @param string|null $starter starter
     *
     * @return self
     */
    ...
    {
        if (is_null($starter)) {
            array_push($this->openAPINullablesSetToNull, 'starter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('starter', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($pro)) {
            array_push($this->openAPINullablesSetToNull, 'pro');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pro', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
